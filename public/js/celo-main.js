    ...
    lightwallet.keystore.createVault({
        ...
        ks.keyFromPassword(password, function (err, pwDerivedKey) {
            if (err) {
                ...
                var web3 = new Web3(new Web3.providers.HttpProvider('https://celo-alfajores.infura.io/v3/e5dc1327315c41d4b12b7502842daf55'));
                var addresses_list = "";
                        ...
                        web3.eth.getBalance("0x" + address, function(error, balance) {
                            ...
                            resolve(`
                                <div class="address-item">
                                    ...
                                    <p><strong>Balance:</strong> ${web3.fromWei(balance, "ether")} CELO</p>
                                </div>
                            `);
                        });
                    });
        ...
        ks.keyFromPassword(password, function (err, pwDerivedKey) {
            if (err) {
                ...
                var provider = new HookedWeb3Provider({
                    host: "https://celo-alfajores.infura.io/v3/e5dc1327315c41d4b12b7502842daf55",
